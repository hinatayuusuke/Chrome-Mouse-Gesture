...
const I18N = {
  ja: {
    ...
    actions: {
      ...
      muteTab: "タブをミュート",
      unmuteTab: "タブのミュート解除",
      moveTabToNewWindow: "タブを新しいウィンドウへ移動",
      openTabIncognitoWindow: "タブを新しいシークレットウィンドウで開く",
  ...
  en: {
    ...
    actions: {
      ...
      moveTabFirst: "Move Tab to First",
      moveTabLast: "Move Tab to Last",
      pinTab: "Pin Tab",
      unpinTab: "Unpin Tab",
      ...
      openTabIncognitoWindow: "Open Tab in New Incognito Window",
